CREATE DATABASE  IF NOT EXISTS `kjsky` ;
USE `kjsky`;
...
CREATE TABLE `address_book` (
                                ...
                                `is_default` tinyint NOT NULL DEFAULT '0' COMMENT '默认 0 否 1是', -- MODIFIED: Changed tinyint(1) to tinyint
                                PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜品及套餐分类';
...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜品';
...
CREATE TABLE `dish_flavor` (
                               ...
                               PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜品口味关系表';
...
CREATE TABLE `orders` (
                          ...
                          `delivery_status` tinyint NOT NULL DEFAULT '1' COMMENT '配送状态  1立即送出  0选择具体时间', -- MODIFIED: Changed tinyint(1) to tinyint
                          `delivery_time` datetime DEFAULT NULL COMMENT '送达时间',
                          `pack_amount` int DEFAULT NULL COMMENT '打包费',
                          `tableware_number` int DEFAULT NULL COMMENT '餐具数量',
                          `tableware_status` tinyint NOT NULL DEFAULT '1' COMMENT '餐具数量状态  1按餐量提供  0选择具体数量', -- MODIFIED: Changed tinyint(1) to tinyint
                          PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='套餐';
...
CREATE TABLE `setmeal_dish` (
                                ...
                                PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='套餐菜品关系';
